...
# sample_vec = np.load('../data/sample_vector/doc2vec/sample_vec_list.npy')
...
train_set, label_train, test, label_test = functions.get_10sets(healthy, ill)
...
# functions.plot_matrix(y_true, y_predict, [0, 1], title='confusion_matrix_randSVM_10',
