...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/ia/ia_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=3,size=100)
model.save('../data/ia/ia_model.model')
...
with open('../data/ia/ia_words.vec', 'a') as word_vec_file:
