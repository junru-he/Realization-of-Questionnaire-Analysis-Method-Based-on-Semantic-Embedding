...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/non_seq/non_seq_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=3,size=100)
model.save('../data/non_seq/non_seq_model.model')
...
with open('../data/non_seq/non_seq_words.vec', 'a') as word_vec_file:
