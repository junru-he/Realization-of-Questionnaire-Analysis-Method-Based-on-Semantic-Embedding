...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/ga/ga_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=3,size=100)
model.save('../data/ga/ga_model.model')
...
with open('../data/ga/ga_words.vec', 'a') as word_vec_file:
