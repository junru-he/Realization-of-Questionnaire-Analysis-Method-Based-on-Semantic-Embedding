...
#word2vec model
sentences = gensim.models.word2vec.LineSentence('../data/greedy/greedy_document.seq')
model = gensim.models.Word2Vec(sentences, hs=1,min_count=1,window=3,size=100)
model.save('../data/greedy/greedy_model.model')
...
with open('../data/greedy/greedy_words.vec', 'a') as word_vec_file:
